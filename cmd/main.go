...
import (
	...
	"github.com/ShaunakJoshi1407/ai-inference-orchestrator/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "98302ea6.example.com",
	...
	if err := (&controller.AIDeploymentReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "Failed to create controller", "controller", "AIDeployment")
		os.Exit(1)
	}
