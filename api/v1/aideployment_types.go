...
type AIDeploymentStatus struct {
	...
	// conditions represent the current state of the AIDeployment resource.
...
// AIDeployment is the Schema for the aideployments API
type AIDeployment struct {
	...
	// spec defines the desired state of AIDeployment
	// +required
	Spec AIDeploymentSpec `json:"spec"`

	// status defines the observed state of AIDeployment
	// +optional
	Status AIDeploymentStatus `json:"status,omitzero"`
}
